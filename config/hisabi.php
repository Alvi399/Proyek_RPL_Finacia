...
return [
    ...
    'reports' => [
        (new SectionDivider)->withTitle("🎖️ Rangkuman Akun"),
        ...
        (new SectionDivider)->withTitle("📊 Analisa Kategori"),
...
//        new ChangeRatePerBrandTrend,
        ...
        (new SectionDivider)->withTitle("📊 Analisa Brands"),
        new TotalPerBrand,
        new TotalPerBrandTrend,

        (new SectionDivider)->withTitle("💰 Fakta"),
        ...
        (new SectionDivider)->withTitle("🧬 Visualisasi"),
